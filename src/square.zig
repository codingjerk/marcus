...
pub const Square = packed struct {
    ...
    pub inline fn fromFileRankIndexes(file: u6, rank: u6) Self {
        return Self.fromIndex(file + rank * 8);
    }
    ...
    pub inline fn getFileIndex(self: Self) u6 {
        return self.index % 8;
    }

    pub inline fn getRankIndex(self: Self) u6 {
        return self.index >> 3;
    }
